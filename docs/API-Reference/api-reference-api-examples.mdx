---
title: Get started with the Axie Studio API
...
You can use the Axie Studio API for programmatic interactions with Axie Studio, such as the following:

* Create and edit flows, including file management for flows.
* Develop applications that use your flows.
* Develop custom components.
* Build Axie Studio as a dependency of a larger project.
* Contribute to the overall Axie Studio project.

To view and test all available endpoints, you can access the Axie Studio API's OpenAPI specification at your Axie Studio deployment's `/docs` endpoint, such as `http://localhost:7860/docs`.
