---
title: Axie Studio release notes
slug: /release-notes
---


This page summarizes significant changes to Axie Studio in each release.
For all changes, see the [Changelog](https://github.com/axiestudio/axiestudio/releases/latest).

Due to strict SemVer requirements, Axie Studio Desktop can have different patch versions than the core Axie Studio OSS Python package, but the major and minor versions are aligned.
...
- Introduced MCP server functionality to serve Axie Studio tools to MCP-compatible clients.
